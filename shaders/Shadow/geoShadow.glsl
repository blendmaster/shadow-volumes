...
{
    gl_Position = P * vec4(v0, 1); EmitVertex();
    gl_Position = P * vec4(v0 + vec3(0,0,1), 1); EmitVertex();
    gl_Position = P * vec4(v1, 1); EmitVertex();
    gl_Position = P * vec4(v1 + vec3(0,0,1), 1); EmitVertex();
